#ifndef INCLUDED_scene_InterfaceZinc_hh
#define INCLUDED_scene_InterfaceZinc_hh
...
class InterfaceZinc : public InterfaceMetal
{
    public:
        InterfaceZinc();
        ~InterfaceZinc();
...
typedef std::shared_ptr<InterfaceZinc> InterfaceZincOP;
