#ifndef INCLUDED_xbin_hh
#define INCLUDED_xbin_hh
/** \file */
...
struct XformHash_bt24_BCC6 {
  ...
  Grid grid() const { return grid6_; }
  static std::string name() { return "XformHash_bt24_BCC6"; }

  XformHash_bt24_BCC6() {}
  // comment this code because wrong constructor could be used 
  ...
  // XformHash_bt24_BCC6(double cart_resl, double ori_resl, double max_cart = 512.0) {
  //   this->cart_bound_ = max_cart;
  //   init(cart_resl, ori_resl, max_cart);
  // }
  ...
  //   // do you really want to call this constructor????????????????????
  //   // 2021-10-27
  //   std::cout<<"get into wrong constructor !!!!!! check xbin !!!!";
  //   exit(0);
  // }
  int get_ori_nside() {
    int ori_nside = 1;
