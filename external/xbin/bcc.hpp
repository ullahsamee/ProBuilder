...
struct BCC {
  ...
  std::vector<I> get_neighbors_6_3_index(I index, int rad, bool exhalf, bool oddlast3,
                     bool sphere) const noexcept {
    std::vector<I> neighbour_key;
    bool odd = index & 1;
